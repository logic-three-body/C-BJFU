...
{
public:
	Animal(const char *name);                                   //声明基类构造函数
...
Animal::Animal(const char *name)                               //Animal类构造函数的定义
{
...
{
public:
	Cat(const char* name,const char *catcolor);
	virtual void print_color();                        //声明虚函数print_color()
	virtual void speak();                               //声明虚函数speak()
	virtual ~Cat();
private:
...
Cat::Cat(const char* name,const char *color) :Animal(name)     //Cat类构造函数的定义
{
